    ...
    process {
        ...
        foreach ($sqlObject in $InputObject) {
            ...
            foreach ($destinstance in $Destination) {
                ...
                if ($fqtndest -eq $fqtnfrom -and $server.Name -eq $destServer.Name -and $server.Databases[$Database] -eq $destServer.Databases[$DestinationDatabase] -and (Test-Bound -ParameterName Query -Not)) {
